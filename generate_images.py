...
for i in range(0, len(items), chunk_size):
    ...
    url = f"https://it.wikipedia.org/w/api.php?action=query&prop=pageimages&titles={titles}&pithumbsize=800&format=json"
...
print(f"Successfully fetched {len(out_data)} images.")
